...
func employeeHandler(w http.ResponseWriter, r *http.Request) {
	...
	case "POST":
		...
		//10 values but 13 required, ID and recordCreatedDate autogenerated and no endDate for new employee
		...
		//change rowsAffected - have a look at what should be the response to a POST response in REST architecture
...
Ask Salman about deleting an employee, general delete from databse or create status for all employees
enabled or disabled.
Pagination
